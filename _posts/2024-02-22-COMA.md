...
어떤 케이스에는 아래와 같이 R이 TD error로 변하기도 한다. Advantage function의 *unbiased version*이다. 일반적인 TD의 경우 V(s*t)에서 V(s*(t+1))로 이동하는 action이 명확하게 정의되지 않기 때문에 bias가 발생하지만 해당하는 action이 존재하고 활용 가능하다면 Advantage function에서 TD error를 활용하더라도 bias를 발생시키지 않는다.
...
![Screenshot from 2024-02-23 16-48-17](/바탕화면/singforai.github.io/images/2024-02-22-COMA/Screenshot from 2024-02-23 16-48-17-1708678593085-6.png)

> > > > > > > f2d6a3d3d88f8597ed06a8ba592d2fbe3aae6765
...
=======
![Screenshot from 2024-02-23 17-34-16](/바탕화면/singforai.github.io/images/2024-02-22-COMA/Screenshot from 2024-02-23 17-34-16-1708678588909-4.png)
